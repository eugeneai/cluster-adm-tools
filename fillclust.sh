...
UDIRS="home root"
#UDIRS="test2"
RSYNC="rsync --timeout=15 --stats --progress -av -zz --exclude-from=exclude-main.txt --delete-after"
URSYNC="rsync --timeout=15 --stats --progress -avu -zz --max-size=5M --exclude-from=exclude-main.txt"
WHERE="root@$IP:$FROOT"
RSYNC_PASSWORD="1111"
FDEV="/root/dev"
